document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        pl: {
            ...
            advanced16: "Dostępność pomocy</h4><p>Ułatwiamy dostęp poprzez geolokalizację.</p>",
            advanced17: "Wsparcie emocjonalne</h4><p>Oferujemy chatbot i rozmowy z konsultantami.",
            advanced18: "Społeczność wzajemnej pomocy</h4><p>Łączymy osoby potrzebujące z tymi, którzy chcą pomóc.",
            advanced19: "Kompleksowe rozwiązanie</h4><p>Od podstawowych potrzeb po plany powrotu do samodzielności.",
        },
        en: {
            ...
            advanced16: "Help availability</h4><p>We make access easier through geolocation.</p>",
            advanced17: "Emotional support</h4><p>We offer a chatbot and expert consultations.</p>",
            advanced18: "Mutual aid community</h4><p>We connect those in need with those who want to help.</p>",
            advanced19: "Comprehensive solution</h4><p>From basic needs to plans for regaining independence.</p>",
        }
    };
